...
class BladeDataset(utils.Dataset):

    def load_blade(self, dataset_dir, subset):
        """Load a subset of the blade dataset.
...
def train(model, dataset_dir, subset):
    """Train the model."""
    # Training dataset.
    dataset_train = BladeDataset()
    dataset_train.load_blade(dataset_dir, subset)
    dataset_train.prepare()

    # Validation dataset
    dataset_val = BladeDataset()
    dataset_val.load_blade(dataset_dir, "val")
    dataset_val.prepare()
...
def detect(model, dataset_dir, subset):
    ...
    # Read dataset
    dataset = BladeDataset()
    dataset.load_blade(dataset_dir, subset)
    dataset.prepare()
    # Load over images
    submission = []
